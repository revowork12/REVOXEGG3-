...
export default function OrdersManagement() {
    ...
    try {
      ...
      if (error) {
        ...
        if (newStatus === 'collected') {
          ...
          console.log(`✅ Order ${orderId} marked as completed and removed`)
        } else {
  ...
  const calculateTotal = (orderId: string): number => {
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4">
        {orders.map((order) => {
          ...
          const currentSelectedStatus = selectedStatuses[order.id] || order.status
              ...
              <div className="mb-4">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
                    ...
                    <button
                      onClick={() => updateOrderStatus(order.id, currentSelectedStatus)}
